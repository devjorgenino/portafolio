...
import { getDataTestimonials } from "@/data";
...
const Testimonials = () => {
  ...
  const dataTestimonials = getDataTestimonials(locale);

  return (
    <div className="p-4 md:px-12 md:py-44 max-w-5xl mx-auto">
      <Title
        title={locale === "es" ? "Testimonios" : "Testimonials"}
        subtitle={locale === "es" ? "Recomendaciones" : "Recommendations"}
      />
